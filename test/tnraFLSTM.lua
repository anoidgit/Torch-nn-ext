...
print("set tensor type to FloatTensor")
...
cmd:option('--savepath', paths.concat(dl.SAVE_PATH, 'nraFLSTMlm'), 'path to directory where experiment log (includes model) will be saved')
cmd:option('--id', '528', 'id string of this experiment (used to name output file) (defaults to a unique id)')
