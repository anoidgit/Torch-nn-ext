...
cmd:option('--savepath', paths.concat(dl.SAVE_PATH, 'nraGRUlm'), 'path to directory where experiment log (includes model) will be saved')
cmd:option('--id', '525', 'id string of this experiment (used to name output file) (defaults to a unique id)')
